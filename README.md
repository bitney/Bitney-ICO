...
## Truffle Sample Codes
```
// ERC721 Contract address setting
BTNYToken.deployed().then(function(contractInstance) {
    contractInstance.setERC721Address("0x9a3e2aab369b3f4357bf79685cd89dab48335b09", {
            gas: 2000000,
            from: address,
        ...
        .then(function(success) {
            if (success) {
                console.log('Updated Character ERC721 Token Address!');
            } else {
                console.log('Error in Updating Character ERC721 Token Address!');
            }
        })
        .catch(function(e) {
...
BTNYToken.deployed().then(function(contractInstance) {
    alert("Please wait for a moment. Usually Ethereum network takes time.");
    contractInstance.tokensale(address, {
            gas: 2000000,
            from: address,
            gasPrice: gasPrice * gasPriceDecimal,
        ...
        .then(function(success) {
            if (success) {
                alert('Token Sale done successfully!');
            } else {
                alert('Error in Token Sale!');
            }
        })
        .catch(function(e) {
            // There was an error! Handle it.
